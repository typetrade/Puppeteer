...
namespace Puppeteer.Helpers
{
    ...
    {
        public static object ValueFromRemoteObject<T>(RemoteObject remoteObject, bool stringify = false)
        {
        ...
        public static async Task ReleaseObjectAsync(CDPSession client, RemoteObject remoteObject, ILogger logger)
        {
