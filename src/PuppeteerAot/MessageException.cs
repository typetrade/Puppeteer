...
namespace Puppeteer
{
    ...
    public class MessageException : PuppeteerException
    {
        ...
        public MessageException(MessageTask callback, ConnectionError error) : base(GetCallbackMessage(callback, error))
        {
        }
        ...
        public static string GetCallbackMessage(MessageTask callback, ConnectionError connectionError)
        {
