...
namespace Puppeteer.BrowserData
{
    ...
    public static class Chrome
    {
        ...
        public static async Task<string> ResolveBuildIdAsync(ChromeReleaseChannel channel)
        ...
        public static string RelativeExecutablePath(Platform platform, string builId)
            => platform switch
            {
        ...
        public static string ResolveSystemExecutablePath(Platform platform, ChromeReleaseChannel channel)
        {
            switch (platform)
            {
                case Platform.Win64:
