...
namespace Puppeteer.BrowserData
{
    ...
    public static class Firefox
    {
        ...
        public static Task<string> GetDefaultBuildIdAsync() => ResolveBuildIdAsync(DefaultBuildId);

        public static string ResolveDownloadUrl(Platform platform, string buildId, string baseUrl)
            =>
        ...
        public static async Task<string> ResolveBuildIdAsync(string channel)
        {
        ...
        public static string RelativeExecutablePath(Platform platform, string buildId)
            => platform switch
            {
        ...
        public static void CreateProfile(string tempUserDataDirectory, Dictionary<string, object> preferences)
        {
