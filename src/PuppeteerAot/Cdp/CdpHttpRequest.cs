...
public class CdpHttpRequest : Request<CdpHttpResponse>
{
    ...
    public override ResponseData ResponseForRequest
    {
        get
        {
            if (!_allowInterception)
    ...
    public override RequestAbortErrorCode AbortErrorReason
    {
        get
        {
            if (!_allowInterception)
    ...
    public override async Task FinalizeInterceptionsAsync()
    {
    ...
    public override void EnqueueInterceptionAction(Func<IRequest, Task> pendingHandler)
