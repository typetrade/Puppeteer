...
namespace Puppeteer.QueryHandlers
{
    public class QueryHandler
    {
        ...
        public virtual async Task<IElementHandle> QueryOneAsync(IElementHandle element, string selector)
        {
        ...
        public async Task<IElementHandle> WaitForAsync(
            Frame frame,
        ...
        public virtual async IAsyncEnumerable<IElementHandle> QueryAllAsync(IElementHandle element, string selector)
        {
