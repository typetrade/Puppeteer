...
namespace Puppeteer
{
    public class EmulationManager
    {
        ...
        public async Task RegisterSpeculativeSessionAsync(CDPSession client)
        {
        ...
        public async Task<bool> EmulateViewportAsync(ViewPortOptions viewport)
        {
            _viewport = viewport;
        ...
        public Task ResetDefaultBackgroundColorAsync()
            => _client.SendAsync("Emulation.setDefaultBackgroundColorOverride");

        public Task SetTransparentBackgroundColorAsync()
