...
namespace Puppeteer
{
    ...
    public interface IResponse
    {
        ...
        /// <summary>
        /// Returns a Task which resolves to a <see cref="JsonElement"/> representation of response body.
        /// </summary>
        /// <seealso cref="JsonAsync{T}"/>
        /// <returns>A Task which resolves to a <see cref="JsonElement"/> representation of response body.</returns>
