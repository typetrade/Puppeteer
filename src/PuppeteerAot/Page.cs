...
namespace Puppeteer
{
    ...
    public abstract class Page : IPage
    {
        ...
        public Page(TaskQueue screenshotTaskQueue)
        {
        ...
        public Touchscreen Touchscreen { get; init; }

        public Coverage Coverage { get; init; }

        public Tracing Tracing { get; init; }

        public Mouse Mouse { get; init; }

        public bool IsDragging { get; set; }

        public bool HasPopupEventListeners => Popup?.GetInvocationList().Any() == true;

        public bool HasErrorEventListeners => Error?.GetInvocationList().Any() == true;
        ...
        public void OnPopup(IPage popupPage) => Popup?.Invoke(this, new PopupEventArgs { PopupPage = popupPage });

        /// <summary>
        /// Raises the <see cref="Dialog"/> event.
        /// </summary>
        /// <param name="message">Dialog message.</param>
        public void OnDialog(PageJavascriptDialogOpeningResponse message)
        {
