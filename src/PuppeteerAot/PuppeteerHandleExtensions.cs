...
namespace Puppeteer
{
    ...
    public static class PuppeteerHandleExtensions
    {
        ...
        public static MessageArgument FormatArgument(this IJSHandle jSHandle, ExecutionContext context)
        {
            ...
            {
                return new MessageArgument() { UnserializableValue = unserializableValue };
            }

            if (jSHandle.RemoteObject.ObjectId == null)
            {
                return new MessageArgument() { Value = jSHandle.RemoteObject.Value.GetRawText() };
            }
        ...
        public static async Task<IEnumerable<IElementHandle>> FastTransposeIteratorHandleAsync(this IJSHandle handle)
        {
